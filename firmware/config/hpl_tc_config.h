...
#ifndef CONF_TC3_CC0
#define CONF_TC3_CC0                                                                                                   \
	(uint32_t)(((float)CONF_TC3_TIMER_TICK / 1000000.f) / (1.f / (CONF_GCLK_TC3_FREQUENCY / CONF_TC3_PRESCALE))) - 1
    // The -1 is critical for cycle accuracy and an oversight in Atmel Start / ASF
#endif
...
#define CONF_TC4_TIMER_TICK 4294967295
#endif
// </h>
...
#ifndef CONF_TC4_CC0
#define CONF_TC4_CC0                                                                                                   \
	(uint32_t)(((float)CONF_TC4_TIMER_TICK / 1000000.f) / (1.f / (CONF_GCLK_TC4_FREQUENCY / CONF_TC4_PRESCALE))) - 1
#endif
